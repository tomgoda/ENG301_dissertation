...
function update_calc(mat1, mat2, slid_x_sub, slid_y_sub, slid_x_layer, slid_y_layer, left_box, right_box, initial_hc)
    ...
    left_box.Value = {'Numerical Method 2 - Equation 9', ...
                      ['Initial Value of hc ', num2str(hc_0/100), ' anstroms'], ...
                      ['Iterated Value of hc = ', num2str(new_hc/100), ' anstroms'], ...
    ...
    right_box.Value = {'Numerical Method 2 - Equation 7', ...
                      ['Initial Value of hc ', num2str(hc_0/100), ' anstroms'], ...
                      ['Iterated Value of hc = ', num2str(new_hc/100), ' anstroms'], ...
                      ['Converged in ', num2str(i), ' iterations!'], ...
                      '% --- --- --- %', ...
