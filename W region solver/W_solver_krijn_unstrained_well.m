...
ground_state_QW = ground_state_solver(band_edges_final(1,6),length_QW,(-1*(band_edges_final(2,2)-min(band_edges_final(1,2), band_edges_final(2,4)))));
ground_state_centre = ground_state_solver(band_edges_final(2,5),length_cent,(-1*band_edges_final(2,1)+band_edges_final(2,3)));

ground_state_QW = ground_state_QW + band_edges_final(2,2);
...
elseif isreal(ground_state_centre)
    band_gap = -1*ground_state_centre + band_edges_final(2,2);
else
    band_gap = -1*band_edges_final(2,3) + band_edges_final(2,2);
end
...
ec_QW = sym(band_edges_final(2,1));
ev_QW = sym(band_edges_final(2,2));
