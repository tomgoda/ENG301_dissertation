...
extract_and_plot("120mA curve.txt");
extract_and_plot("140mA curve.txt");
extract_and_plot("160mA curve.txt");
extract_and_plot("180mA curve.txt");
extract_and_plot("200mA curve.txt");
...
function extract_and_plot(file_name)
    ...
    curve_name = extractBetween(file_name, 1, min(11, strlength(file_name)));
    ...
    %plot(locs, pks, 'o', 'DisplayName',peak_name + 'mA peak')
end
